...
export const AboutAppLanding = () => {
  ...
  return (
    <div className="about-app md:px-32 bg-base w-full md:h-screen flex flex-col items-center justify-center md:gap-6">
      ...
      <div className="about-card-row flex md:flex-row w-full md:h-80 justify-center items-center md:gap-5">
        {about?.map((i) => {
          return (
            <div
              key={i.id}
              className="about-card rounded-xl bg-white shadow-lg md:h-64 md:w-72 flex flex-col items-center justify-center md:gap-3 md:p-5 hover:scale-110 duration-200"
            >
              {/* <Image
                  ...
                  /> */}
              <img
                src={`http://localhost:3000/images/${i.image}`}
                alt={i.title}
              />
